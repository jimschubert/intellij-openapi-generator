...
//        private val app = ApplicationManager.getApplication()
    ...
    init {
        outputBrowse.addBrowseFolderListener(
                org.openapitools.codegen.intellij.Message of "dialog.generate.output-browse.title",
                null,
                project,
        ...
        title = org.openapitools.codegen.intellij.Message of "dialog.generate.title"
        setOKButtonText(org.openapitools.codegen.intellij.Message of "dialog.generate.ok")
        setCancelButtonText(org.openapitools.codegen.intellij.Message of "dialog.generate.cancel")
    ...
    private fun createPrimitivesPanel() {
        primitivesPanel = ValuePropertiesPanel(
                org.openapitools.codegen.intellij.Message of "panel.primitive-types.value-column"
        )
        primitivesPanel.setEmptyMessage(org.openapitools.codegen.intellij.Message of "panel.primitive-types.empty-message")
    }

    private fun createTypeMappingsPanel() {
        typeMappingsPanel = KeyValuePropertiesPanel(
                org.openapitools.codegen.intellij.Message of "panel.type-mappings.key-column",
                org.openapitools.codegen.intellij.Message of "panel.type-mappings.value-column"
        )
        typeMappingsPanel.setEmptyMessage(org.openapitools.codegen.intellij.Message of "panel.type-mappings.empty-message")
    }

    private fun createImportMappingsPanel() {
        importMappingsPanel = KeyValuePropertiesPanel(
                org.openapitools.codegen.intellij.Message of "panel.import-mappings.key-column",
                org.openapitools.codegen.intellij.Message of "panel.import-mappings.value-column"
        )
        importMappingsPanel.setEmptyMessage(org.openapitools.codegen.intellij.Message of "panel.import-mappings.empty-message")
    }

    private fun createAdditionalPropertiesPanel() {
        additionalPropertiesPanel = KeyValuePropertiesPanel(
                org.openapitools.codegen.intellij.Message of "panel.additional-properties.key-column"
        )
        additionalPropertiesPanel.setEmptyMessage(org.openapitools.codegen.intellij.Message of "panel.additional-properties.empty-message")
    }

    private fun createInstantiationTypesPanel() {
        instantiationTypesPanel = KeyValuePropertiesPanel(
                org.openapitools.codegen.intellij.Message of "panel.instantiation-types.key-column",
                org.openapitools.codegen.intellij.Message of "panel.instantiation-types.value-column"
        )
        instantiationTypesPanel.setEmptyMessage(org.openapitools.codegen.intellij.Message of "panel.instantiation-types.empty-message")
    }
