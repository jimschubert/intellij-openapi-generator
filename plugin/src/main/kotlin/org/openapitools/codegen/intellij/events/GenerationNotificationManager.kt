...
package org.openapitools.codegen.intellij.events
...
class GenerationNotificationManager {
    ...
    fun success(lang: String, outputDir: String) {
        ...
        val title = org.openapitools.codegen.intellij.Message.of("notification.generation.success.title", GROUP)
        val content = org.openapitools.codegen.intellij.Message.of("notification.generation.success.content", lang, outputDir)
    ...
    fun failure(t: Throwable? = null){
        val project = ProjectManager.getInstance().openProjects.firstOrNull()
        val title = org.openapitools.codegen.intellij.Message.of("notification.generation.failure.title", GROUP)
