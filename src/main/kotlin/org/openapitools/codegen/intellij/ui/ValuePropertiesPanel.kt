    ...
    init {
        ...
        _editor = object : ValidatingTableEditor<SimpleValueItem>() {
            ...
            override fun validate(item: SimpleValueItem?): String? {
                when {
                    item == null -> {
                        return org.openapitools.codegen.intellij.Message of "panel.value-properties.invalid-empty"
                    }
                    item.value == "" -> {
                        return org.openapitools.codegen.intellij.Message of "panel.value-properties.invalid-value"
                    }
                }
